...
import { Loader2, CheckCircle2, XCircle, AlertTriangle } from "@lucide/vue";
...
<template>
    <Dialog v-model:open="isOpen">
        <DialogContent
            class="max-w-4xl max-h-[85vh] flex flex-col p-0 gap-0 overflow-hidden"
        >
            ...
            <div class="flex-1 overflow-y-auto p-6">
                ...
                <div v-else-if="result" class="space-y-6">
                    ...
                    >
                        <component
                            :is="result.success ? CheckCircle2 : AlertTriangle"
                        ...
                        <div>
                            ...
                            <div
                                v-if="result.success && result.token"
                    ...
                    <Tabs v-model="activeTab" class="w-full">
                        ...
                        <TabsContent value="summary" class="space-y-4 pt-4">
                            <div class="grid grid-cols-2 gap-4">
                                <div class="space-y-1">
                                    ...
                                    >
                                    <div
                                        class="font-mono text-sm break-all p-2 bg-muted rounded"
                                    >
                                        {{ result.requestUrl }}
                                    </div>
                                </div>
                                <div class="space-y-1">
                                    ...
                                    >
                                    <div
                                        class="font-mono text-sm p-2 bg-muted rounded"
                                    >
                                ...
                                <div class="space-y-1">
                                    ...
                                    >
                                    <div
                                        class="font-mono text-sm p-2 bg-muted rounded flex items-center gap-2"
                                    >
                                        <span
                                            :class="{
                                                'text-green-600':
                        ...
                        <TabsContent value="request" class="space-y-4 pt-4">
                            <div class="space-y-2">
                                ...
                                <div
                                    v-if="result.requestHeaders.length > 0"
                                    class="border rounded text-xs font-mono"
                                >
                                    <div
                                        v-for="h in result.requestHeaders"
                                        :key="h.name"
                                        class="flex border-b last:border-0 p-2"
                                    >
                                        <span
                                            class="w-1/3 text-muted-foreground border-r pr-2 mr-2 truncate"
                                            >{{ h.name }}</span
                                        >
                            ...
                            <div class="space-y-2">
                                ...
                                <div
                                    class="bg-muted p-3 rounded-md overflow-x-auto"
                                >
                        ...
                        <TabsContent value="response" class="space-y-4 pt-4">
                            <div class="space-y-2">
                                <h4 class="text-sm font-medium">Headers</h4>
                                <div
                                    v-if="result.responseHeaders.length > 0"
                                    class="border rounded text-xs font-mono"
                                >
                                    <div
                                        v-for="h in result.responseHeaders"
                                        :key="h.name"
                                        class="flex border-b last:border-0 p-2"
                                    >
                                        <span
                            ...
                            <div class="space-y-2">
                                <h4 class="text-sm font-medium">Body</h4>
                                <div
                                    class="bg-muted p-3 rounded-md overflow-x-auto max-h-[300px]"
                                >
                                    <pre class="text-xs font-mono">{{
