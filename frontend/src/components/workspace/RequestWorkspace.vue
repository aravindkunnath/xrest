...
import { Plus, X, Settings2, Play } from "@lucide/vue";
                        ...
                        >
                            ...
                            >
                                ...
                                <span class="truncate text-sm">{{
                                    tab.url && tab.url !== 'https://api.example.com/' && tab.title === 'New Request' ? tab.url.replace(/^https?:\/\//, '') : tab.title
                                }}</span>
                                <span
                                    v-if="tab.isEdited"
                                    class="w-1.5 h-1.5 rounded-full bg-primary flex-shrink-0 ml-1"
                                ></span>
                            </div>
                    ...
                    >
                        <ResizablePanelGroup direction="vertical">
                            ...
                            >
                                ...
                                >
                                    <Tabs
                                        v-model="tab.activeSubTab"
                                        class="flex-1 flex flex-col overflow-hidden"
                                    >
                                        <TabsList
                                            class="justify-start h-9 bg-transparent border-b px-4 rounded-none shrink-0"
                                        >
                                            <TabsTrigger
                                                value="params"
                                        ...
                                        <div class="flex-1 overflow-auto">
                                            ...
                                            <TabsContent
                                                value="preflight"
                                                class="p-0 m-0 overflow-visible"
                                            >
                                                <div class="p-4">
                                                    <div
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <label
                                                                    class="text-[10px] uppercase font-bold text-muted-foreground mb-1 block"
                                                                    >Method</label
                                                                >
                                                                <select
                                                                    v-model="
