...
watch(
    ...
    () => {
        ...
        const sourceEnv = props.sourceCollection.environments.find(
            (e) =>
                e.name ===
                (props.sourceCollection?.selectedEnvironment || "GLOBAL"),
        );
    ...
    <Dialog :open="open" @update:open="emit('update:open', $event)">
        <DialogContent class="sm:max-w-[700px] gap-0 p-0 overflow-hidden">
            <DialogHeader class="p-6 pb-4 border-b">
                ...
                <DialogDescription>
                    Migrate "{{ endpoint?.name }}" from collections to a
                    permanent service.
                </DialogDescription>
            </DialogHeader>
                ...
                <div class="px-6 py-4 space-y-6 overflow-y-auto">
                    ...
                    <div class="space-y-3">
                        ...
                        <Select v-model="selectedServiceId">
                            ...
                            <SelectContent>
                                <SelectGroup>
                                    <SelectLabel
                                        >Available Services</SelectLabel
                                    >
                                    <SelectItem
                        ...
                        >
                            <Info class="h-3 w-3" /> Select a service to see
                    ...
                    >
                        ...
                        <div v-if="variablesToCreate.length > 0">
                                ...
                                <Table>
                                    <TableHeader>
                                        <TableRow class="hover:bg-transparent">
                                            ...
                                            >
                                            <TableHead
                                                class="w-32 uppercase font-bold"
                                                >Status</TableHead
                                            >
                                        </TableRow>
                                    </TableHeader>
                                    <TableBody>
                                        ...
                                        >
                                            <TableCell>
                                                <Checkbox
                                                    v-model:checked="v.selected"
                                                />
                                            </TableCell>
                                            <TableCell class="py-2">
                                                <Input
                                                    v-model="v.name"
                                                    class="h-7 bg-background"
                                                />
                                            </TableCell>
                                            <TableCell class="py-2">
                                                <Input
                            ...
                            >
                                <Info class="h-3 w-3 shrink-0" /> Selected
                                variables will be added to all environments of
                                "{{
                ...
                <div class="p-6 bg-muted/50 border-t mt-auto">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="text-muted-foreground font-medium">
                            The endpoint will be moved and removed from the
                            scratchpad.
                        </div>
                    </div>
