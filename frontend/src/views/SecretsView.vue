...
import { Plus, Trash2, Shield, Eye, EyeOff } from "@lucide/vue";
        ...
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-muted-foreground mt-1">
                    Manage your sensitive keys and credentials securely stored
        ...
        <div class="rounded-xl border bg-card text-card-foreground shadow">
            <div class="p-6 flex flex-col space-y-1.5">
                ...
                <p class="text-sm text-muted-foreground">
                    These secrets can be used as variables in your requests
                    using
            ...
            <div class="p-6 pt-0">
                ...
                >
                    <Shield
                        class="h-12 w-12 text-muted-foreground mx-auto mb-4 opacity-20"
                    />
                    <h3 class="text-lg font-medium">No secrets found</h3>
                    <p
                        class="text-sm text-muted-foreground max-w-sm mx-auto mt-2"
                    >
                        You haven't added any secrets yet. Secrets are stored
                        securely and are not synced to git.
                    </p>
                    <Button
                        variant="outline"
