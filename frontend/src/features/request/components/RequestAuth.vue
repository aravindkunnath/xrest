...
import { ShieldCheck, Globe, Play } from "@lucide/vue";
...
import InterpolatedTextarea from "@/components/editor/InterpolatedTextarea.vue";
import RequestParameters from "@/features/request/components/RequestParameters.vue";
import TestPreflightDialog from "@/features/dialogs/TestPreflightDialog.vue";
        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-[120px_1fr] items-center gap-4">
                ...
                <Select v-model="auth.type">
                    ...
                    <SelectContent>
                        <SelectItem value="bearer" class=""
                            >Bearer Token</SelectItem
                        >
                        <SelectItem value="basic" class=""
                            >Basic Auth</SelectItem
                        >
            ...
            <template v-if="auth.type === 'apikey'">
                ...
                >
                    ...
                    <Select v-model="auth.apiKeyLocation">
                        ...
                        <SelectContent>
                            <SelectItem value="header" class=""
                                >Header</SelectItem
                            >
                            <SelectItem value="query" class=""
                                >Query Params</SelectItem
                            >
                        </SelectContent>
                    </Select>
                </div>
        ...
        <div v-if="auth.type === 'bearer'" class="space-y-4 pt-4">
            ...
            >
                <div class="space-y-3">
                    ...
                    >
                    <div
                        class="flex items-center gap-2 bg-muted/50 p-2 rounded border"
                    >
                        <Select v-model="preflight.method">
                            <SelectTrigger
                                class="w-24 h-8 font-bold bg-background"
                            >
                                <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                    ...
                    <div v-if="preflight.method !== 'GET'" class="space-y-2">
                        <div class="flex items-center justify-between">
                            ...
                            <Select v-model="preflight.bodyType">
                                <SelectTrigger
                                    class="h-6 w-fit font-medium bg-background border-none shadow-none focus:ring-0 px-2"
                                >
                                    <SelectValue />
                                </SelectTrigger>
                                <SelectContent>
                        ...
                        >
                            <div class="space-y-1.5">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    />
                                    <Select
                                        v-model="preflight.cacheDurationUnit"
                                    >
                                        <SelectTrigger class="h-7 w-20">
                                            <SelectValue />
                                        </SelectTrigger>
                                        <SelectContent>
                                            <SelectItem value="seconds" class=""
                                                >sec</SelectItem
                                            >
                                            <SelectItem value="minutes" class=""
                                                >min</SelectItem
                                            >
                                            <SelectItem value="hours" class=""
                                                >hrs</SelectItem
                                            >
                                            <SelectItem value="days" class=""
                                                >days</SelectItem
                                            >
                                        </SelectContent>
                                    </Select>
                ...
                >
                    // This request will run automatically to obtain and refresh
