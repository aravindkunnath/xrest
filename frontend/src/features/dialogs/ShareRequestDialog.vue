...
import { ref } from "vue";
import { Share2, Copy } from "@lucide/vue";
import {
    Dialog,
    DialogContent,
    DialogDescription,
...
import { useCodeGenerator } from "@/features/request/composables/useCodeGenerator";
    ...
    <Dialog :open="open" @update:open="emit('update:open', $event)">
        <DialogContent class="sm:max-w-[700px] p-0 overflow-hidden gap-0">
            <DialogHeader class="p-6 pb-4 border-b">
                ...
                <DialogDescription>
                    Export your request to various programming languages and
                    formats.
                </DialogDescription>
            </DialogHeader>
            ...
            <div class="flex flex-col h-[450px]">
                <!-- Setup Bar -->
                <div
                    class="p-4 bg-muted/20 border-b flex items-center justify-between"
                >
                    <div class="flex items-center gap-3">
                        ...
                        <Select v-model="shareLanguage">
                            ...
                            <SelectContent>
                                <SelectItem value="curl" class=" "
                                    >cURL</SelectItem
                                >
                                <SelectItem value="node" class=" "
                                    >Node.js (Axios)</SelectItem
                                >
