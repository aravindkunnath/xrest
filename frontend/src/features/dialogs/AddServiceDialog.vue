...
import { ChevronLeft, ChevronRight, Folder, Plus } from "@lucide/vue";
import {
    Dialog,
    DialogContent,
    DialogDescription,
        ...
        <DialogContent class="sm:max-w-[700px]">
            ...
            <div v-if="serviceDialogStep === 1" class="grid gap-6 py-4">
                ...
                >
                    ...
                    <Switch
                        id="is-auth"
                        v-model:checked="newServiceForm.isAuth"
                    />
                </div>
                <div
                ...
                <div class="border rounded-md overflow-hidden">
                    <Table>
                        <TableHeader class="bg-muted/30">
                            <TableRow>
                                <TableHead class="w-[150px] font-bold"
                                    >Key</TableHead
                                >
                        ...
                        <TableBody>
                            <TableRow
                                v-for="(
                                    env, idx
                                ) in newServiceForm.environments"
                                :key="idx"
                            >
