...
import CollectionExplorer from "@/features/collections/components/CollectionExplorer.vue";
...
const handleSaveRequest = async (payload: {
  ...
  try {
    ...
    const finalCollection = collectionsStore.collections[payload.serviceIndex];
    const finalEndpoint = finalCollection?.endpoints.find(
