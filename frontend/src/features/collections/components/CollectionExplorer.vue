...
import { Search, Plus, X, Layers, PlusCircle } from "@lucide/vue";
import {
    Popover,
    PopoverContent,
    PopoverTrigger,
} from "@/components/ui/popover";
import ServiceTree from "@/features/services/components/ServiceTree.vue";
        ...
        <div class="flex-1 overflow-auto p-2">
            ...
            <ServiceTree
                ...
                @select-service-settings="
                    emit('select-service-settings', $event)
                "
