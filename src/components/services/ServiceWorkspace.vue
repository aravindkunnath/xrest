...
import { Play, Plus, Settings2, X } from "lucide-vue-next";
...
const { gitStatuses } = useGitIntegration();
            ...
            <ResizablePanel :default-size="50" :min-size="20">
              <div class="h-full p-4 overflow-auto">
                ...
                <div class="min-h-[200px]">
                  ...
                  <RequestHistory v-else-if="tab.activeSubTab === 'versions'" :tabId="tab.id" :versions="tab.versions || []"
